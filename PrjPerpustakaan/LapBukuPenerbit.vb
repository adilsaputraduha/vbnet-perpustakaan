...
Public Class LapBukuPenerbit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrjPerpustakaan.LapBukuPenerbit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapBukuPenerbit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapBukuPenerbit = New LapBukuPenerbit()
        rpt.Site = Me.Site
        Return rpt
    End Function
