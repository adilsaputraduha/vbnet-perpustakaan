Public Class FormPengembalian
    Sub set_dg()
        ...
        dgv.Columns(2).HeaderText = "Faktur Peminjaman"
        dgv.Columns(3).HeaderText = "Tanggal Kembali"
        dgv.Columns(4).HeaderText = "Total Kembali"
    ...
    Private Sub btnTambah_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTambah.Click
        With FormTambahPengembalian
            .TopLevel = False
            FormMenu.pnDashboard.Controls.Add(FormTambahPengembalian)
            .BringToFront()
            .Show()
        End With
    End Sub
