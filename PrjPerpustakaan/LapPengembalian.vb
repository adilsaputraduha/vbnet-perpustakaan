...
Public Class LapPengembalian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrjPerpustakaan.LapPengembalian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapPengembalian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapPengembalian = New LapPengembalian()
        rpt.Site = Me.Site
        Return rpt
    End Function
