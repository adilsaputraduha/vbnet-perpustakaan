...
Public Class FakturPeminjaman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrjPerpustakaan.FakturPeminjaman.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFakturPeminjaman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FakturPeminjaman = New FakturPeminjaman()
        rpt.Site = Me.Site
        Return rpt
    End Function
